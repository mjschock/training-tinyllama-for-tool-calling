...
# training_tinyllama_for_tool_calling documentation build
...
from training_tinyllama_for_tool_calling import __version__ as release

# -- Project information -----------------------------------------------------

project = "training_tinyllama_for_tool_calling"
author = "Kedro"
...
htmlhelp_basename = "training_tinyllama_for_tool_callingdoc"
...
latex_documents = [
    (
        master_doc,
        "training_tinyllama_for_tool_calling.tex",
        "training_tinyllama_for_tool_calling Documentation",
        "Kedro",
        "manual",
    )
]
...
man_pages = [
    (
        master_doc,
        "training_tinyllama_for_tool_calling",
        "training_tinyllama_for_tool_calling Documentation",
        [author],
        1,
    )
...
texinfo_documents = [
    (
        ...
        author,
        "training_tinyllama_for_tool_calling",
        "Project training_tinyllama_for_tool_calling codebase.",
        "Data-Science",
    )
]
